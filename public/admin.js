...
function renderDashboardStats(d){const t=d.today||{},v=d.visitors||{};return '<div class="stat visitor-today"><span>👥 Today Visitors</span><b>'+Number(v.today_unique_visitors||0)+'</b><small>आज unique visitors</small></div><div class="stat visitor-total"><span>🌐 Total Visitors</span><b>'+Number(v.total_unique_visitors||0)+'</b><small>Unique browsers</small></div><div class="stat"><span>👁️ Today Page Visits</span><b>'+Number(v.today_visits||0)+'</b><small>आज website visits</small></div><div class="stat"><span>📈 Total Page Visits</span><b>'+Number(v.total_visits||0)+'</b><small>All-time visits</small></div><div class="stat today-sold"><span>🛒 Today Sold IDs</span><b>'+Number(t.today_sold_ids||0)+'</b><small>आज बिके हुए IDs</small></div><div class="stat today-added"><span>➕ Today IDs Added</span><b>'+Number(t.today_ids_added||0)+'</b><small>आज stock में जोड़े गए</small></div><div class="stat today-rejected"><span>❌ Today Reject</span><b>'+Number(t.today_rejected||0)+'</b><small>आज rejected payments</small></div><div class="stat today-approved"><span>✅ Today Approve</span><b>'+Number(t.today_approved||0)+'</b><small>आज approved payments</small></div><div class="stat"><span>📦 Available IDs</span><b>'+Number(d.stock||0)+'</b><small>Current stock</small></div><div class="stat"><span>📊 Total Sold IDs</span><b>'+Number(d.sold||0)+'</b><small>All-time sold</small></div><div class="stat"><span>⏳ Pending Approval</span><b>'+(d.orders||[]).filter(x=>x.status==='payment_received').length+'</b><small>Waiting for admin</small></div><div class="stat"><span>🧾 Recent Orders</span><b>'+(d.orders||[]).length+'</b><small>Latest 100 orders</small></div>';}
